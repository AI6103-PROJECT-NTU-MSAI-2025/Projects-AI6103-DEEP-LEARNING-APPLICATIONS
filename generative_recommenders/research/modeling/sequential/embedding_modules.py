...
class ItemEmbeddingWithText(EmbeddingModule):
    ...
    def get_item_embeddings(self, item_ids: torch.Tensor) -> torch.Tensor:
        ...
        # New: ResNet Residual MLP Fusion
            ...
            # 1. Base Summation: E_ID + E_Text
            base_sum = item_embeds + projected_text_embeds
            # 2. Hadamard Interaction Term: E_ID * E_Text
            ...
            raise ValueError(
                f"Unknown fusion mode: {self._fusion_mode}. Supported modes are 'sum', 'concat_mlp', 'gated','modulating_sum','resnet_mlp'.")
